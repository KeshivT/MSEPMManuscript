...
Despite their widespread use, these methods do not account for other factors that also contribute to the variability of DNA methylation data.
 ...
 models that describe the per site relationship between methylation and these factors. We utilized the MSEPM with a large aggregate cohort of blood
  ...
  genes that are not expressed in blood. These observations suggest mechanisms that underlie age associated methylation changes and suggest 
...
We implemented a simulation framework using the MSEPM formulation to evaluate the performance of the MSEPM model under various conditions.
...
four epigenetic factors described above. We then simulated methylation values using the simulated site rates. Simulated samples
 ...
 absolute error (MAE) between the predicted epigenetic states and the simulated epigenetic factors decreases (Figure 2A). Importantly, to accurately
  assess simulated age it is necessary to account for the influence of the other simulated factors (Sex, CN, CE). 
...
and reasonable predicted cell type abundance estimates (Figure 3C). The first principal component of a PCA model trained cell type abundance estimates (CT-PC1) is 
...
Based on these results we hypothesize that the mechanisms that underlie the gain of methylation with age at these 
...
in methylation sites, suggesting that these were caused by the loss of H3K4Me3 at bivalent promoters of genes that are silenced 
...
\bibliography{MSEPM-Manuscript-Updated.bib}
...
\begin{center}
    \begin{figure}
    \includegraphics[scale=.25]{Figure1.png}    
    \footnotesize
...
\begin{center}
    \begin{figure}
    \includegraphics[scale=.2]{Figure2.png}
    \footnotesize
...
\begin{center}
    \begin{figure}
    \includegraphics[scale=.2]{Figure3.png}
    \footnotesize
...
\begin{raggedleft}
\begin{figure}
\includegraphics[scale=.15]{Figure4.png}
\footnotesize
...
\begin{center}
    \begin{figure}
    \includegraphics[scale=.15]{Figure5.png}
    \footnotesize
...
\begin{center}
    \begin{figure}
    \includegraphics[scale=.15]{Figure6.png}
    \footnotesize
...
\begin{center}
    \begin{figure}
    \includegraphics[scale=.15]{Figure7.png}
    \footnotesize
